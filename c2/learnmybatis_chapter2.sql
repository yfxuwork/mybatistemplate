/*
 ...
 Source Schema         : learnmybatis

 Target Server Type    : MySQL
 Target Server Version : 50561
 File Encoding         : 65001

 Date: 26/09/2018 13:41:15
*/
...
CREATE TABLE `sys_user`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1005 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
